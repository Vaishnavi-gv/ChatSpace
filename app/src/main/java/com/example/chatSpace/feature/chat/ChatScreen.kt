package com.example.chatSpace.feature.chat

import com.example.chatSpace.feature.model.Message
import com.example.chatSpace.ui.theme.DarkGray
import com.example.chatSpace.ui.theme.purple
...
import com.example.chatSpace.feature.home.ChannelItem
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Row(
            ...
            IconButton(onClick = {
                ...
                Image(
                    painter = painterResource(id = R.drawable.attach_svgrepo_com), contentDescription = "send"
                )
            }
            ...
            IconButton(onClick = {
                ...
                Image(painter = painterResource(id = R.drawable.send_email_svgrepo_com), contentDescription = "send")
            }
        }
    }
}
